# Update pokemon_detail.html to use sprite images
...
<body>
    ...
    <div class="container">
        ...
        <div class="pokemon-card rarity-{{ pokemon.rarity|lower }}">
            ...
            {% else %}
            <div class="pokemon-image" style="font-size: 5rem; display: flex; align-items: center; justify-content: center; margin: 0 auto;">🐾</div>
            {% endif %}
...
print('Updated pokemon_detail.html with sprite images!')
