# Fix my_team.html sizing and layout
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .pokemon-card .member-icon { font-size: 2rem; }
            ...
            <div class="pokemon-grid">
                ...
                <a href="{% url 'pokemon:pokemon_detail' p.0.id %}" class="team-member-link">
                    <div class="pokemon-card">
                        <div class="member-icon">🐾{% if p.1 %}<span class="shiny-star">⭐</span>{% endif %}</div>
...
print('my_team.html sizing fixed!')
